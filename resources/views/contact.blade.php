...
<body>
        ...
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              ...
              <a href="#"><span class="mai-mail text-primary"></span> muntazir@gmail.com</a>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{('myappointment')}}">My Appointment</a>
            </li>
  ...
  <div class="page-section">
    <div class="container">
      ...
      <form class="contact-form mt-5"   action="{{url('send')}}"   method="post">
